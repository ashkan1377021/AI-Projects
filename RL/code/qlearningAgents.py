...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        for legal_action in legal_actions:
            Q_max = max(Q_max, self.getQValue(state, legal_action))
    ...
    def computeActionFromQValues(self, state):
        ...
        for legal_action in legal_actions:
            if self.getQValue(state, legal_action) == value:
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feature in features_vector:
            Q_value += self.weights[feature] * features_vector[feature]
        return Q_value
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feature in features_vector:
            self.weights[feature] += self.alpha * diff * features_vector[feature]
